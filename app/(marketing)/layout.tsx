...
export const metadata: Metadata = {
  metadataBase: new URL('https://cryptoanalytix.com'),
  title: 'Crypto Analytix | AI Market Intelligence for Traders',
  description:
  ...
  openGraph: {
    title: 'Crypto Analytix — Your AI-Powered Trading Edge',
    description:
      'The AI trading platform that gets smarter every day you use it. Stocks, forex, crypto, and futures.',
    images: [
      { url: '/og-image.png', width: 1200, height: 630, alt: 'Crypto Analytix' },
    ],
    type: 'website',
    siteName: 'Crypto Analytix',
