  ...
  return (
    <div className="rounded-xl border bg-card p-5">
      <div className="flex items-center gap-2 mb-4">
        <ArrowBendRightDown size={16} className="text-[#4A90C4]" />
      ...
      <div className="rounded-lg bg-muted/40 p-3 mb-3 border-l-2 border-muted-foreground/20">
        <div className="flex items-center gap-2 mb-1.5">
          ...
          <span className="px-1.5 py-0.5 rounded text-[9px] font-semibold bg-[#D4A042]/10 text-[#D4A042]">ForexAnalytix</span>
        </div>
      ...
      <div className="flex items-center gap-1.5 mb-2">
        <Bird size={14} weight="fill" className="text-[#4A90C4]" />
        <span className="text-[11px] uppercase tracking-wider font-bold text-[#4A90C4]">PELICAN TRANSLATION</span>
      </div>
