        ...
        <div className="flex gap-2.5">
          ...
          <div className="max-w-[90%] space-y-2.5">
            <div className="bg-slate-50 border border-slate-200 rounded-xl rounded-tl-sm px-3 py-2.5 space-y-2">
              {/* Funding Rates */}
              <div>
                <p className="text-[10px] font-medium uppercase tracking-wider text-[#4A90C4] mb-1">Funding Rates</p>
              ...
              {/* TradFi Translation */}
              <div>
                <p className="text-[10px] font-medium uppercase tracking-wider text-[#4A90C4] mb-1">TradFi Translation</p>
                <p className="text-xs text-slate-600">
              ...
              {/* Your Position */}
              <div>
                <p className="text-[10px] font-medium uppercase tracking-wider text-[#4A90C4] mb-1">Your Position</p>
              ...
              <div className="pt-1 border-t border-slate-200">
                <p className="text-[10px] font-medium uppercase tracking-wider text-[#4A90C4] mb-1">Recommendation</p>
                <p className="text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1 px-2">
              <motion.div
                className="w-1.5 h-1.5 rounded-full bg-[#4A90C4]"
