    ...
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden h-[360px] flex flex-col">
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-200">
        ...
        <div className="ml-auto flex items-center gap-1.5">
          ...
          <span className="text-[10px] text-slate-400">GPT-5</span>
        </div>
      </div>
        ...
        <div className="flex gap-2.5">
          ...
          <div className="max-w-[90%] space-y-2.5">
            <div className="bg-slate-50 border border-slate-200 rounded-xl rounded-tl-sm px-3 py-2.5 space-y-2">
              {/* Technical Setup */}
              <div>
                <p className="text-[10px] font-medium uppercase tracking-wider text-blue-600 mb-1">Technical Setup</p>
              ...
              {/* Implied Move */}
              <div>
                <p className="text-[10px] font-medium uppercase tracking-wider text-blue-600 mb-1">Implied Move</p>
                <p className="text-xs text-slate-600">
              ...
              {/* Consensus */}
              <div>
                <p className="text-[10px] font-medium uppercase tracking-wider text-blue-600 mb-1">Consensus Estimates</p>
              ...
              <div className="pt-1 border-t border-slate-200">
                <p className="text-[10px] font-medium uppercase tracking-wider text-blue-600 mb-1">Recommendation</p>
                <p className="text-xs text-slate-600">
