  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden h-[360px] flex flex-col">
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-200">
        <div className="w-6 h-6 rounded-full bg-[#4A90C4]/10 flex items-center justify-center">
          <Lightning weight="fill" className="w-3.5 h-3.5 text-[#4A90C4]" />
        </div>
      ...
      <div className="flex-1 overflow-hidden px-4 py-3 space-y-3">
        ...
        <div className="flex gap-2.5 justify-end">
          <div className="max-w-[85%] bg-[#4A90C4]/10 border border-[#4A90C4]/20 rounded-xl rounded-tr-sm px-3 py-2">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl rounded-tl-sm px-3 py-2.5 space-y-2.5">
              ...
              <div>
                <div className="flex items-center gap-1.5 mb-1">
                  <Warning weight="fill" className="w-3 h-3 text-[#E06565]" />
                  <p className="text-[10px] font-medium uppercase tracking-wider text-[#E06565]">Warning</p>
                </div>
                <p className="text-xs text-slate-600">
                  Your meme coin record is <span className="font-mono tabular-nums text-[#E06565]">2-7</span> with <span className="font-mono tabular-nums text-[#E06565]">$3,200</span> in losses.
              ...
              <div>
                <div className="flex items-center gap-1.5 mb-1">
                  <Clock weight="fill" className="w-3 h-3 text-[#D4A042]" />
                  <p className="text-[10px] font-medium uppercase tracking-wider text-amber-600">Context</p>
                </div>
                <p className="text-xs text-slate-600">
                  You&apos;re on a <span className="font-mono tabular-nums text-slate-900">3-trade</span> losing streak on alts. After 3+ consecutive losses, your next trade wins only <span className="font-mono tabular-nums text-[#E06565]">18%</span> of the time. Funding is <span className="font-mono tabular-nums text-[#E06565]">0.04%/8h</span> &mdash; expensive carry.
                </p>
              </div>
              ...
              <div className="pt-1 border-t border-slate-200">
                <div className="flex items-center gap-1.5 mb-1">
                  <ShieldCheck weight="fill" className="w-3 h-3 text-[#4A90C4]" />
                  <p className="text-[10px] font-medium uppercase tracking-wider text-[#4A90C4]">Coaching</p>
                </div>
