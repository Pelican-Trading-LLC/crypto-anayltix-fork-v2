    ...
    <div className={cn(
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-lg shadow-slate-200/50 overflow-hidden">
        ...
        <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-100">
          <div className="w-7 h-7 rounded-full bg-[#1DA1C4]/10 flex items-center justify-center">
            <Lightning weight="fill" className="w-4 h-4 text-[#1DA1C4]" />
          </div>
        ...
        <div className="px-4 py-4 space-y-3 min-h-[320px] sm:min-h-[360px]">
          ...
          {showUser && (
            <div className="flex justify-end animate-fade-in">
              <div className="text-white text-sm rounded-2xl rounded-br-sm px-4 py-2.5 max-w-[85%]" style={{ background: 'linear-gradient(135deg, #1A6FB5, #25BFDF)' }}>
          ...
          {showThinking && (
            <div className="flex items-center gap-2 animate-fade-in">
              <div className="w-6 h-6 rounded-full bg-[#1DA1C4]/10 flex items-center justify-center flex-shrink-0">
                <Lightning weight="fill" className="w-3 h-3 text-[#1DA1C4]" />
              </div>
              ...
              <div className="space-y-2.5 flex-1 min-w-0">
                ...
                {showBlock1 && (
                  <div className="animate-fade-slide-up rounded-xl bg-slate-50 border border-slate-200 p-3">
                    <p className="text-[10px] uppercase tracking-wider font-medium text-[#1DA1C4] mb-1.5">
                      Your Position
                    </p>
                    <p className="text-xs text-slate-600 leading-relaxed">
                      ...
                      Currently <span className="font-mono font-medium text-red-600">-2.46%</span> at
                ...
                {showBlock2 && (
                  <div className="animate-fade-slide-up rounded-xl bg-slate-50 border border-slate-200 p-3">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs text-slate-600">
                        In TradFi terms: you&apos;re paying <span className="font-mono font-medium text-red-600">34% annual carry</span> on
                ...
                {showBlock3 && (
                  <div className="animate-fade-slide-up rounded-xl bg-[#1DA1C4]/5 border border-[#1DA1C4]/20 p-3">
                    <p className="text-[10px] uppercase tracking-wider font-medium text-[#1DA1C4] mb-1.5">
                      Recommendation
                    </p>
