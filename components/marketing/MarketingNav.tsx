    ...
    <nav>
      <div className="nav-inner">
        <Link href="/" className="nav-logo">
          <div className="w-8 h-8 rounded-[8px] flex items-center justify-center text-white text-[10px] font-bold" style={{ background: 'linear-gradient(135deg, #2C5F8A, #5B4F8A)' }}>CA</div>
