...
export const MOCK_ANALYST_POSTS = [
  { id: 'ap1', type: 'analyst' as const, asset: 'BTC', analyst_name: 'Sample Harmonic Analyst', analyst_color: '#2A5ADA', methodology: 'HARMONIC', direction: 'BULLISH' as const, title: 'BTC Sample Harmonic Setup', body: 'Sample harmonic setup for layout preview. Live entry, target, and stop levels require connected feeds.', key_levels: { entry: '<sample>', target: '<sample>', stop: '<sample>' }, confidence: 78, timestamp: '2h ago', in_portfolio: true },
  { id: 'ap2', type: 'analyst' as const, asset: 'ETH', analyst_name: 'Sample Wave Analyst', analyst_color: '#9945FF', methodology: 'ELLIOTT WAVE', direction: 'BEARISH' as const, title: 'ETH Sample Wave Correction', body: 'Sample wave-count narrative for layout preview. Live entry, target, and stop levels require connected feeds.', key_levels: { entry: '<sample>', target: '<sample>', stop: '<sample>' }, confidence: 65, timestamp: '4h ago', in_portfolio: true },
]
...
export const MOCK_MACRO_SIGNALS = [
  { id: 'mt1', type: 'macro' as const, source: 'ForexAnalytix', analyst: 'Sample Macro Analyst', title: 'DXY Sample Macro Signal', body: 'Sample cross-asset macro signal for layout preview. Live analyst attribution requires connected feeds.', affected_assets: ['BTC', 'ETH', 'SOL'], timestamp: '5h ago' },
]
...
export const MOCK_TOKEN_INTEL: Record<string, TokenIntelData> = {
  ...
  ETH: {
    ...
    pelican_synthesis: 'Sample ETH synthesis for layout preview. Derivatives, smart-money flow, and cross-asset confluence are displayed here when live feeds are connected.',
  ...
  SOL: {
    ...
    pelican_synthesis: 'Sample SOL synthesis for layout preview. Unlocks, derivatives positioning, and ecosystem activity are displayed here when live feeds are connected.',
  ...
  WIF: {
    ...
    pelican_synthesis: 'Sample high-risk token synthesis for layout preview. Live warnings and risk language require connected market, derivatives, and on-chain feeds.',
...
export const MOCK_ALERTS: IntelAlert[] = [
  ...
  { id: 'a6', category: 'cross_asset', severity: 'medium', title: 'Sample macro risk-off shift', body: 'Sample ForexAnalytix-style macro alert for layout preview. Live analyst attribution and trade implications require connected feeds.', affected_assets: ['BTC', 'ETH', 'SOL'], timestamp: '12h ago', read: true },
  ...
  { id: 'a_fa1', category: 'cross_asset', severity: 'high', title: 'Sample macro support test', body: 'Sample ForexAnalytix-style macro alert for layout preview. Live analyst attribution and trade implications require connected feeds.', affected_assets: ['BTC', 'ETH', 'SOL'], timestamp: '1h ago', read: false },
  { id: 'a_fa2', category: 'cross_asset', severity: 'medium', title: 'Sample FACE Webinar: Risk-off regime developing in bonds', body: 'Sample FACE panel summary for layout preview. Live analyst names, levels, and position guidance require connected feeds.', affected_assets: ['ETH', 'SOL', 'AVAX'], timestamp: '3h ago', read: false },
...
export const MOCK_BRIEF_V2 = {
  pelican_synthesis: {
    ...
    the_play: 'Sample playbook placeholder. Live strategy suggestions require connected data feeds and compliance review.',
  },
  cross_asset: {
    ...
    analyst_name: 'Sample Macro Analyst',
...
export const MOCK_ANALYST_SETUPS: AnalystSetup[] = [
  { analyst: 'Sample Harmonic Analyst', initials: 'HA', color: '#2C5F8A', token: 'BTC', pattern: 'Bat Pattern', direction: 'Bullish', entry: '<sample>', target: '<sample>', stop: '<sample>', timeframe: '4H', description: 'Sample harmonic setup for layout preview. Live analyst names, levels, and position commentary require connected feeds.' },
  { analyst: 'Sample Pattern Analyst', initials: 'PA', color: '#5B4F8A', token: 'SOL', pattern: 'Bull Flag', direction: 'Bullish', entry: '<sample>', target: '<sample>', stop: '<sample>', timeframe: '1D', description: 'Sample pattern setup for layout preview. Live analyst names, levels, and position commentary require connected feeds.' },
  { analyst: 'Sample Wave Analyst', initials: 'WA', color: '#5B4F8A', token: 'GOLD', pattern: 'Elliott Wave', direction: 'Bullish', entry: '<sample>', target: '<sample>', stop: '<sample>', timeframe: '1W', description: 'Sample wave setup for layout preview. Live analyst names, levels, and position commentary require connected feeds.' },
  { analyst: 'Sample RWA Analyst', initials: 'RA', color: '#4A90C4', token: 'ONDO', pattern: 'Cup & Handle', direction: 'Bullish', entry: '<sample>', target: '<sample>', stop: '<sample>', timeframe: '4H', description: 'Sample RWA setup for layout preview. Live analyst names, levels, and position commentary require connected feeds.' },
  { analyst: 'Sample Wave Analyst', initials: 'WA', color: '#5B4F8A', token: 'ETH', pattern: 'Elliott Wave', direction: 'Bearish', entry: '<sample>', target: '<sample>', stop: '<sample>', timeframe: '4H', description: 'Sample wave setup for layout preview. Live analyst names, levels, and position commentary require connected feeds.' },
  { analyst: 'Sample Macro Analyst', initials: 'MA', color: '#2C5F8A', token: 'DXY', pattern: 'Head & Shoulders', direction: 'Bearish', entry: '<sample>', target: '<sample>', stop: '<sample>', timeframe: '1D', description: 'Sample macro setup for layout preview. Live analyst names, levels, and position commentary require connected feeds.' },
]

export const ANALYST_PERFORMANCE: Record<string, { cumPnl: number[]; trend: string }> = {
  'Sample Harmonic Analyst': { cumPnl: [0, 220, 180, 420, 650, 580, 810, 1050, 980, 1240], trend: 'up' },
  'Sample Pattern Analyst': { cumPnl: [0, -80, 120, 350, 280, 510, 680, 720, 890, 1100], trend: 'up' },
  'Sample Wave Analyst': { cumPnl: [0, 150, 310, 280, 180, 340, 290, 420, 380, 450], trend: 'mixed' },
  'Sample RWA Analyst': { cumPnl: [0, -120, -80, 150, 320, 280, 480, 650, 820, 960], trend: 'up' },
}
...
export const MOCK_X_FEED: XPost[] = [
  ...
  { handle: 'sampleanalyst', displayName: 'Sample Analyst', verified: true, profileHue: 260, text: 'Sample social post for layout preview. Live posts require connected feeds and verified attribution.', likes: 1240, retweets: 340, replies: 210, time: '12h', tweetUrl: 'https://x.com' },
]
